 ...
 * - チャレンジ＝リスクリターン：長文（5文）・打鍵中のミスはバグ化×2
 *   報酬（rewardMult）は**進捗ブースト＋完遂ボーナスのバグ-1**に使う（DevelopScreen 側）。
 *   v0.19.1：当初は devStats（品質ボーナス）に乗せていたが、AXIS_QUALITY_BONUS_CAP（+8）
 *   に埋もれて最終スコアにほぼ反映されず「選ぶ意味がない」FBを受けて進捗側に付け替えた。
